...
export const UserMenu: React.FC<UserMenuProps> = ({
  ...
  useLayoutEffect(() => {
    ...
    const updateMenuPosition = () => {
      ...
      const maxHeight = Math.max(180, window.innerHeight - top - VIEWPORT_PADDING);
  ...
  const menu = open && menuPosition
    ? createPortal(
        <div
          ref={menuRef}
          className="fixed z-[140] animate-fade-in motion-reduce:animate-none"
          style={{
          ...
          role="menu"
        >
          <div className="glass-dropdown rounded-2xl overflow-hidden">
